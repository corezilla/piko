...
|---|---|---|---|---|---|---|
| TAIL-P-001 | `design.system` 章节映射 | keep/tailor | Piko Agent Runtime 作为本项目 system；当前简化 authority 为9节，映射见 migration map | 章节编号不与模板逐字相同 | User / Piko Project Owner（2026-09-07） | N/A |
...
| TAIL-P-010 | STD 来源 SHA-256 manifest | keep | 以 `docs/std.lock.json` 与来源manifest锁定 draft.21 revision `274ef0a67eda080baa0063ae27ede7ee129aa32a` | STD revision 变化时必须重新生成并复审 | Approved | N/A |
