...
| Runtime API contract | `docs/contracts/agent-runtime-openapi-v0.2.yaml` | 未来 generated route/types |
| Base Schema/errors | `docs/contracts/schemas/agent-runtime-v0.2.schema.json`、error catalog | 未来 contract package |
| Matrix 增量 contract | v0.3 OpenAPI/Schema/error/fixture | 未来 CollaborationBridge package |
| Validator | `scripts/validate_v03_contract.py` | CI contract validation |
...
验证策略和具体 case 见 `docs/assurance/piko-agent-runtime-vv-plan-v0.3.md` 与
