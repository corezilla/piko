...
SCHEMA_PATH = ROOT / "docs/contracts/schemas/agent-runtime-matrix-v0.3.schema.json"
BASE_SCHEMA_PATH = ROOT / "docs/contracts/schemas/agent-runtime-v0.2.schema.json"
OPENAPI_PATH = ROOT / "docs/contracts/agent-runtime-matrix-openapi-v0.3.yaml"
ERROR_PATH = ROOT / "docs/contracts/error-blocker-catalog-v0.3.json"
FIXTURE_PATH = ROOT / "docs/contracts/fixtures/v0.3/collaboration-decision-fixtures.json"
